			...
			<div id="content">
				...
				<div class="container-fluid" id="main-content">
					<div class="d-sm-flex justify-content-between align-items-center mb-4">
						<h3 class="text-dark mb-0">FAQ 관리</h3>
						<a class="btn btn-danger btn-sm d-none d-sm-inline-block" role="button"
							href="${pageContext.request.contextPath}/customer/deleteFaq"> <i
							class="fas fa-download fa-sm text-white-50"></i> &nbsp;체크한 문의 삭제
						</a>
					</div>
					<div class="row">
												...
												<div class="row align-items-center no-gutters">
													<div class="col me-2">
														<details>
															<summary>
																<h6 class="mb-0">
																	<strong class="txt-FAQ" contenteditable="true" inputmode="text">${faqVo.faqTitle}</strong>
																</h6>
															</summary>
															<br />
